        ...
        <div className="flex flex-col overflow-y-auto md:flex-row">
          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <Label>
                <span>Email</span>
                <Input onChange={(v) => setUserName(v.target.value)} className="mt-1" type="email" placeholder="john@doe.com" />
              </Label>

              <Label className="mt-4">
                <span>Password</span>
                <Input onChange={(v) => setPassword(v.target.value)} className="mt-1" type="password" placeholder="***************" />
              </Label>
